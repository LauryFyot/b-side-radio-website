...
const dict = {
  fr: {
    ...
    "comments.moderation": "Chaque message est relu par l'equipe avant publication.",
    "comments.pending": "En attente de validation",
  ...
  en: {
    ...
    "comments.send": "Send",
    "comments.moderation": "Every message is reviewed by the crew before publication.",
